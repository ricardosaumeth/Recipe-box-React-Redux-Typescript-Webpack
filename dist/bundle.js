...
function addEditRecipeBtn(addEdit, recipeName, ingredients) {
...
exports.addEditRecipeBtn = addEditRecipeBtn;
function addRecipe(recipeName, ingredients) {
    payload.recipes.push({ title: recipeName, ingredients: ingredients.split(",") });
...
function editRecipe(OldrecipeName, NewrecipeName, ingredients) {
    if (NewrecipeName) {
...
function deleteItem(recipeName, ingredients) {
    if (recipeName) {
        let index = 0;
        payload.recipes.forEach((recipe) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.LOAD_RECIPES_SUCCESS = 'LOAD_RECIPES_SUCCESS';
exports.ADD_EDIT_RECIPES_BTN_SUCCESS = 'ADD_EDIT_RECIPES_BTN_SUCCESS';
exports.ADD_RECIPE__SUCCESS = 'ADD_RECIPE__SUCCESS';
exports.EDIT_RECIPE__SUCCESS = 'EDIT_RECIPE__SUCCESS';
exports.DELETED_ITEM_SUCCESS = 'DELETED_ITEM_SUCCESS';
...
const ModalAdd_1 = __webpack_require__(26);
class App extends React.Component {
    render() {
        let panels;
        if (this.props.recipeVariables.recipe.recipes != null) {
            let counter = 0;
            panels = this.props.recipeVariables.recipe.recipes.map(function (recipe) {
                counter++;
                return React.createElement(Panel_1.default, { key: counter.toString(), title: recipe.title, ingredients: recipe.ingredients, collapseId: counter.toString() });
            });
        }
        return (React.createElement("div", { className: "container" },
            React.createElement("div", { id: "container", className: "well" },
                React.createElement("div", { role: "tablist", className: "panel-group", id: "accordion" }, panels)),
            React.createElement("button", { id: "btn-del", type: "button", className: "btn btn-primary btn-md", "data-toggle": "modal", "data-target": "#addModal" }, "Add Recipe"),
            React.createElement(ModalAdd_1.default, null)));
    }
}
...
const redux_logger_1 = __webpack_require__(56);
function configureStore(initialState) {
    return redux_1.createStore(reducers_1.default, initialState, redux_1.applyMiddleware(redux_thunk_1.default, redux_logger_1.logger));
}
...
const react_redux_1 = __webpack_require__(3);
const redux_1 = __webpack_require__(2);
const recipeBoxActions_1 = __webpack_require__(4);
class Modal extends React.Component {
    ...
    saveUpdateRecipe() {
        let recipeName = ReactDOM.findDOMNode(this.refs["recipeName"]);
        let recipeIngredients = ReactDOM.findDOMNode(this.refs["ingredients"]);
        this.props.addRecipe(recipeName.value, recipeIngredients.value);
        recipeName.value = "";
        recipeIngredients.value = "";
    }
    render() {
        return (React.createElement("div", { className: "modal fade", id: "addModal", role: "dialog" },
            React.createElement("div", { className: "modal-dialog" },
                React.createElement("div", { className: "modal-content" },
                    React.createElement("div", { className: "modal-header" },
                        React.createElement("button", { type: "button", className: "close", "data-dismiss": "modal" }, "\u00D7"),
                        React.createElement("p", { className: "modal-title" }, "Add Recipe")),
                    React.createElement("div", { className: "modal-body" },
                        React.createElement("form", null,
                            React.createElement("div", { className: "form-group" },
                                React.createElement("label", { className: "control-label" },
                                    React.createElement("span", null, "Recipe")),
                                React.createElement("input", { type: "text", label: "Recipe", placeholder: "Recipe Name", id: "title", className: "form-control", ref: "recipeName", required: true })),
                            React.createElement("div", { className: "form-group" },
                                React.createElement("label", { className: "control-label" },
                                    React.createElement("span", null, "Ingredients")),
                                React.createElement("textarea", { type: "textarea", label: "Ingredients", placeholder: "Enter Ingredients,Separated,By Commas", id: "ingredients", className: "form-control", ref: "ingredients" })))),
                    React.createElement("div", { className: "modal-footer" },
                        React.createElement("button", { type: "button", className: "btn btn-default btn-xs pull-right", "data-dismiss": "modal" }, "Close"),
                        React.createElement("button", { type: "button", className: "btn btn-primary btn-xs pull-right", "data-dismiss": "modal", onClick: this.saveUpdateRecipe }, "Add Recipe"))))));
    }
}
function mapStateToProps(state, ownProps) {
    return {
...
function mapDispatchToProps(dispath) {
    return redux_1.bindActionCreators({
        addRecipe: recipeBoxActions_1.addRecipe
    }, dispath);
}
...
class Modal extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "modal fade", id: "editModal", role: "dialog" },
            React.createElement("div", { className: "modal-dialog" },
                React.createElement("div", { className: "modal-content" },
                    React.createElement("div", { className: "modal-header" },
                        React.createElement("button", { type: "button", className: "close", "data-dismiss": "modal" }, "\u00D7"),
                        React.createElement("p", { className: "modal-title" }, "Edit Recipe")),
                    React.createElement("div", { className: "modal-body" },
                        React.createElement("form", null,
                            React.createElement("div", { className: "form-group" },
                                React.createElement("label", { className: "control-label" },
                                    React.createElement("span", null, "Recipe")),
                                React.createElement("input", { type: "text", label: "Recipe", id: "title", className: "form-control", ref: "recipeName", value: this.state.inputvalue, placeholder: "Recipe Name", onChange: this.updateRecipeName, required: true })),
                            React.createElement("div", { className: "form-group" },
                                React.createElement("label", { className: "control-label" },
                                    React.createElement("span", null, "Ingredients")),
                                React.createElement("textarea", { type: "textarea", label: "Ingredients", placeholder: "Enter Ingredients,Separated,By Commas", id: "ingredients", className: "form-control", ref: "ingredients", value: this.state.textAreaValue, onChange: this.updateIngredients })))),
                    React.createElement("div", { className: "modal-footer" },
                        React.createElement("button", { type: "button", className: "btn btn-default btn-xs pull-right", "data-dismiss": "modal" }, "Close"),
                        React.createElement("button", { type: "button", className: "btn btn-primary btn-xs pull-right", "data-dismiss": "modal", onClick: this.saveUpdateRecipe }, "Edit Recipe"))))));
    }
}
function mapStateToProps(state, ownProps) {
    return {
...
function mapDispatchToProps(dispath) {
    return redux_1.bindActionCreators({
        editRecipe: recipeBoxActions_1.editRecipe
    }, dispath);
}
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(Modal);
...
const react_redux_1 = __webpack_require__(3);
const redux_1 = __webpack_require__(2);
const UnorderedList_1 = __webpack_require__(29);
const ModalEdit_1 = __webpack_require__(27);
const recipeBoxActions_1 = __webpack_require__(4);
    ...
    render() {
        ...
        return (React.createElement("div", { className: "panel panel-success" },
            React.createElement("div", { className: "panel-heading" },
                React.createElement("h4", { className: "panel-title", role: "presentation" },
                    React.createElement("a", { "data-toggle": "collapse", "data-parent": "#accordion", href: "#collapse" + collapseId }, title))),
            React.createElement("div", { id: "collapse" + collapseId, className: "panel-collapse collapse", "aria-hidden": "true", role: "tabpanel" },
                React.createElement("div", { className: "panel-body" },
                    React.createElement("h4", { className: "text-center" }, "Ingredients"),
                    React.createElement("hr", null),
                    React.createElement(UnorderedList_1.default, { ingredients: ingredients }),
                    React.createElement("div", { role: "toolbar", className: "btn-toolbar" },
                        React.createElement("button", { id: "btn-del", type: "button", className: "btn btn-danger", onClick: this.deleteItem }, "Delete"),
                        React.createElement("button", { id: "btn-edit", type: "button", className: "btn btn-default", "data-toggle": "modal", "data-target": "#editModal", onClick: this.editRecipe }, "Edit")))),
            React.createElement(ModalEdit_1.default, null)));
    }
}
function mapDispatchToProps(dispath) {
    return redux_1.bindActionCreators({
        addEditRecipeBtn: recipeBoxActions_1.addEditRecipeBtn,
        deleteItem: recipeBoxActions_1.deleteItem
    }, dispath);
}
exports.default = react_redux_1.connect(null, mapDispatchToProps)(Panel);
...
const Ul = (props) => {
    let counter = 0;
    const ingredients = props.ingredients.map(function (ingredients) {
        counter++;
        return (React.createElement("li", { className: "list-group-item", key: counter.toString() }, ingredients));
    });
    return (React.createElement("ul", { className: "list-group" }, ingredients));
};
exports.default = Ul;
...
const ReactDOM = __webpack_require__(5);
const react_redux_1 = __webpack_require__(3);
const configureStore_1 = __webpack_require__(24);
__webpack_require__(25);
const App_1 = __webpack_require__(23);
const recipeBoxActions_1 = __webpack_require__(4);
const store = configureStore_1.default();
store.dispatch(recipeBoxActions_1.loadRecipes());
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(2);
const reducer_recipeBox_1 = __webpack_require__(33);
const rootReducer = redux_1.combineReducers({
    recipeBox: reducer_recipeBox_1.default
});
...
Object.defineProperty(exports, "__esModule", { value: true });
const types = __webpack_require__(12);
const initialState_1 = __webpack_require__(32);
function courseReducer(state = initialState_1.default, action) {
    switch (action.type) {
        ...
        case types.DELETED_ITEM_SUCCESS:
            return (state = Object.assign({}, state, { recipe: action.payload, recipes: [...state.recipes, action.payload] }));
        default:
            return state;
    }
}
